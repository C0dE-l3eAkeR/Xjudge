       ...
       <div class="row p-3 mt-3">
          ...
          <div class="row">
            ...
            <div class="contest_lsit container-fluid mt-2 p-3 border shadow rounded bg-dark text-light text-center">
                ...
                <form action="create_con_exec.php" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="contestDuration" class="form-label">Duration (in hours)</label>
                        <input type="number" class="form-control" id="contestDuration" name="contestDuration" required>
                    </div>
                    <div class="mb-3">
                        <label for="contestStartTime" class="form-label">Start Time</label>
                        <input type="datetime-local" class="form-control" id="contestStartTime" name="contestStartTime" required>
                    </div>
                    <div class="mb-3">
                        <label for="problemSelection" class="form-label">Select Problems</label>
                        <select multiple class="form-control" id="problemSelection" name="selectedProblems[]" multiple>
                          <?php foreach ($problems as $problem) : ?>
                         
                              <option value="<?php echo $problem['id'] ?>"><?php echo $problem['title']; ?></option>
