    ...
    <div class="container-fluid">
       ...
       <div class="row p-3 mt-3">
          <div class="col-2">
            <div class="d-flex align-items-start">
                <div class="nav flex-column nav-tabs me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  ...
                  <button class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false">|||</button></div>
          ...
          <div class="col-10" data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0"  >
            <h1 id="scrollspyHeading1" class="bg-dark text-white p-5 border rounded">Welcome To The World Of CP</h1>
          </div>
          <div class="row">
            <div class="col-2">
...
<!--            <div class="col-3">-->
<!--                <div class="container border shadow p-3 mb-5 bg-white rounded"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum tempora eligendi illo asperiores est alias dolorum, ratione quia eveniet corrupti inventore, reiciendis deserunt nobis similique cum autem recusandae expedita? Harum!</p></div>-->
<!--            </div>-->
            <div class="col-7">

                <div class="container border shadow p-3 mb-5 bg-white rounded"><p>Virtual Judge is not a real online judge. It can grab problems from other regular online judges and simulate submissions to other online judges. It aims to enable holding contests when you don't have the test data.</p></div>
