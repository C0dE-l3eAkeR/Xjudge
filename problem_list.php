    ...
    <div class="container-fluid">
       ...
       <div class="row p-3 mt-3">
          ...
          <div class="col-10" data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0"  >
            <div id="scrollspyHeading1" class="bg-dark text-white p-5 border rounded">
				<form class="input-group mb-3" action="retrivedata.php" method="post">
				<input type="text" class="form-control" placeholder="paste a CF problem id to add" aria-label="search" aria-describedby="basic-addon2" name="probID">
